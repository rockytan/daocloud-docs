---
title: '如何开发一个基于 Docker 的 Java 应用'
---

> 目标：用 Docker 的方式搭建一个 Java Sprint Boot 应用
> 
...
> 本次基础镜像使用 Java 官方镜像，也可以根据自己的项目需求与环境依赖使用 [定制的 PHP 基础镜像](http://open.daocloud.io/ru-he-zhi-zuo-yi-ge-ding-zhi-de-php-ji-chu-docker-jing-xiang/)。
